...
tags:
  ...
  - type/essay
Sources:
  - "[[Partisan vs Neutral Media]]"
  - https://newscord.org/editorials/jason-arday-pile-on
  - "[[Separate advocacy|Separate advocacy]]"
  - "[[Emotive Reasoning]]"
dg-publish: true
share: true
cssclasses:
...
## Split picture
The discerning Telegraph reader who might venture a peek at the Guardian for balance will often be presented not with a counterargument on an opinion they've recently read, but rather another persuasive opinion on an entirely different issue. A reader is not pulled towards two different views but rather twisted across different problems. It is not possible to resolve a debate between two news sources when one asks how to fund public services and the other how to deregulate the market. Media framing tells you not what to think but [[Media Framing|rather what to think about]]. When a neutral outlet covers a plagiarism scandal, it investigates the procedural failures within the university. But under the partisan lens of media framing, Arday's story was hijacked. It ceased to be about academic citations and became a convenient proxy war, framed as proof of moral decay in elite institutions.
## Full picture?
Where reporting does overlap, reading different viewpoints only surfaces the benefits of each - rarely, if ever, providing any counterargument. It is simply [[Separate advocacy#the importance of refutation|insufficient]] to appraise one opinion by reading the benefits of an opposing one, doing so leaves both viewpoints unopposed, a mirage of rebuttal in a desert of [[Separate advocacy#What is it|separate advocacy]]. 

>[!quote] **[[IJSMEarticle.pdf#page=1&selection=37,45,39,8|two decades of research]]** indicate that reading refutation text rather than traditional expository text is more likely to result in conceptual change.
...
>[!question]- 3 questions...
>Do we really need these people to spoon-feed us what to believe?
>Do we not have our own principles?
>Are we really unable to comprehend the news without their research?
## Boiling point
These self-appointed public opinionators are characteristically witty, persuasive, and eloquent authors who know best how to push the buttons of paper's target audience. 

>[!example] Each Op-ed has a two-fold goal:
